...
import co.shift.pcs.user.control.IUserParallelizer;
...
public class UserManager implements IUserManager {
	...
	@EJB
	private IUserParallelizer parallelizer;
	...
	Query query = em
	.createNativeQuery("SELECT COUNT(*) FROM User p");
	long pCount = (long) query.getSingleResult();
	return parallelizer.getAllUsers(pCount);
	}
