  ...
  public static CharSequence generate(final BusinessEntity be, final String packageName, final List<Association> associations, final IFileSystemAccess fsa) {
      ...
      for(final Contracts contract_1 : _contracts_1) {
        ...
        }
        {
          if ((contract_1 instanceof ListAll)) {
            _builder.append("\t");
            String _extendContribution = DomainCodeGenerator.extendContribution("_r_1", DomainCodeGenerator.CONTRIBUTE_TO_BI, contract_1, be);
            _builder.append(_extendContribution, "\t");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            String _extendContribution_1 = DomainCodeGenerator.extendContribution("_r_1", DomainCodeGenerator.CONTRIBUTE_TO_GENERATION, fsa, packageName, be);
    ...
    _builder.newLine();
    {
      ...
      for(final Association association_2 : _detailMultipleAssociations) {
        ...
        Attribute _iD_7 = DomainCodeGenerator.getID(container_1);
