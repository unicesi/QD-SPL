 ...
 * @generated
 */
public class Domainmetamodelm2mSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Domainmetamodelm2mSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Domainmetamodelm2mPackage.BUSINESS: {
				Business business = (Business)theEObject;
				T result = caseBusiness(business);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Domainmetamodelm2mPackage.BUSINESS_ENTITY: {
				BusinessEntity businessEntity = (BusinessEntity)theEObject;
				T result = caseBusinessEntity(businessEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Domainmetamodelm2mPackage.ATTRIBUTE: {
				Attribute attribute = (Attribute)theEObject;
				T result = caseAttribute(attribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Domainmetamodelm2mPackage.ASSOCIATION: {
				Association association = (Association)theEObject;
				T result = caseAssociation(association);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Domainmetamodelm2mPackage.SIMPLE: {
			...
			case Domainmetamodelm2mPackage.MULTIPLE: {
			...
			case Domainmetamodelm2mPackage.CONTRACTS: {
				Contracts contracts = (Contracts)theEObject;
				T result = caseContracts(contracts);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Domainmetamodelm2mPackage.CREATE: {
			...
			case Domainmetamodelm2mPackage.UPDATE: {
			...
			case Domainmetamodelm2mPackage.RETRIEVE: {
			...
			case Domainmetamodelm2mPackage.DELETE: {
			...
			case Domainmetamodelm2mPackage.LIST_ALL: {
			...
			case Domainmetamodelm2mPackage.CONTRACT_ELEMENTS: {
			...
			case Domainmetamodelm2mPackage.LIST_ELEMENTS: {
			...
			case Domainmetamodelm2mPackage.ADD_ELEMENT: {
			...
			case Domainmetamodelm2mPackage.DELETE_ELEMENT: {
