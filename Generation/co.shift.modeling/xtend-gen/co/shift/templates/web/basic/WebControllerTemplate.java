...
public class WebControllerTemplate {
  public static CharSequence generate(final String packageName, final BusinessEntity be, final List<Association> associations, final IFileSystemAccess fsa) {
    ...
    _builder.newLine();
    _builder.newLine();
    String _extendContribution = DomainCodeUtilities.extendContribution("_r_2_11_15_16", DomainCodeUtilities.CONTRIBUTE_TO_WEB_IMPORT, packageName);
    ...
    _builder.newLine();
    {
      ...
      if (_isMaster) {
        ...
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        String con0 = DomainCodeUtilities.extendContribution("_r_1", DomainCodeUtilities.CONTRIBUTE_TO_WEB_IMPL, conListAll, be, Integer.valueOf(0));
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
          ...
          for(final Association ass_4 : _associations_2) {
            {
              ...
              if (_and) {
                ...
                String _extendContribution_1 = DomainCodeUtilities.extendContribution("_r_2_11_15_16", DomainCodeUtilities.CONTRIBUTE_TO_WEB_IMPL, _plus_4);
    ...
    _builder.newLine();
    {
      ...
      for(final Contracts con_4 : _contract_9) {
        _builder.append("\t");
        String _extendContribution_2 = DomainCodeUtilities.extendContribution("_r_1", DomainCodeUtilities.CONTRIBUTE_TO_WEB_IMPL, con_4, be, Integer.valueOf(1));
      ...
      for(final Contracts c : _contracts) {
        {
          if ((c instanceof ListAll)) {
            _builder.append("\t");
            String _extendContribution_3 = DomainCodeUtilities.extendContribution("_r_1", DomainCodeUtilities.CONTRIBUTE_TO_WEB_IMPL, c, be, Integer.valueOf(0));
          ...
          if (_isMaster_4) {
            {
              if ((c_2 instanceof Create)) {
                ...
                String _extendContribution_4 = DomainCodeUtilities.extendContribution("_r_2_11_15_16", DomainCodeUtilities.CONTRIBUTE_TO_WEB_IMPL, _plus_30);
                ...
                _builder.newLineIfNotEmpty();
                _builder.append("\t\t\t\t\t");
                String con_5 = DomainCodeUtilities.extendContribution("_r_1", DomainCodeUtilities.CONTRIBUTE_TO_WEB_IMPL, conListAll_1, be, Integer.valueOf(0));
                _builder.newLineIfNotEmpty();
                _builder.append("\t\t\t\t\t");
            ...
            }
            {
              if ((c_2 instanceof Update)) {
                ...
                String _extendContribution_5 = DomainCodeUtilities.extendContribution("_r_2_11_15_16", DomainCodeUtilities.CONTRIBUTE_TO_WEB_IMPL, _plus_35);
            ...
            }
            {
              if ((c_2 instanceof Delete)) {
                ...
                String _extendContribution_6 = DomainCodeUtilities.extendContribution("_r_2_11_15_16", DomainCodeUtilities.CONTRIBUTE_TO_WEB_IMPL, _plus_37);
                ...
                _builder.append("\t");
                _builder.append("\t\t\t\t");
                String con_6 = DomainCodeUtilities.extendContribution("_r_1", DomainCodeUtilities.CONTRIBUTE_TO_WEB_IMPL, conListAll_2, be, Integer.valueOf(0));
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("\t\t\t\t");
      ...
      for(final Association ass_8 : _associations_5) {
        {
          if ((ass_8 instanceof Simple)) {
            ...
            String _extendContribution_7 = DomainCodeUtilities.extendContribution("_r_2_11_15_16", DomainCodeUtilities.CONTRIBUTE_TO_WEB_IMPL, _plus_43);
              ...
              if ((ass_9 instanceof Multiple)) {
                ...
                }
                {
                  ...
                  if (_not_6) {
                    ...
                    String _extendContribution_8 = DomainCodeUtilities.extendContribution("_r_2_11_15_16", DomainCodeUtilities.CONTRIBUTE_TO_WEB_IMPL, _plus_47);
      ...
      for(final Association ass_10 : _detailMultipleAssociations_5) {
        ...
        }
        {
          ...
          if (_and_5) {
            ...
            String _extendContribution_9 = DomainCodeUtilities.extendContribution("_r_2_11_15_16", DomainCodeUtilities.CONTRIBUTE_TO_WEB_IMPL, _plus_51);
