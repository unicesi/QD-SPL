...
public class PopUpUserForm extends CustomComponent {
	...
	public static final String ID = "PUF";
	...
	public PopUpUserForm() {
		...
		button_1.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				UserFormController.getInstance().addUserToProject(projectID);
			}
		});
		...
		comboBox_1.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				UserFormController.getInstance().updateUserFormFields();
			}
		});
	}
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(textField_3, "top:146.0px;left:20.0px;");
