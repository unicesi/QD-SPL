...
/**
 * This is the item provider adapter for a {@link domainmetamodel.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DomainmetamodelPackage.Literals.ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DomainmetamodelPackage.Literals.ATTRIBUTE__DATA_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIsRequiredPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_isRequired_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_isRequired_feature", "_UI_Attribute_type"),
				 DomainmetamodelPackage.Literals.ATTRIBUTE__IS_REQUIRED,
				 true,
				 false,
				 false,
	...
	protected void addIsDefaultPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_isDefault_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_isDefault_feature", "_UI_Attribute_type"),
				 DomainmetamodelPackage.Literals.ATTRIBUTE__IS_DEFAULT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Attribute.class)) {
			case DomainmetamodelPackage.ATTRIBUTE__NAME:
			case DomainmetamodelPackage.ATTRIBUTE__DATA_TYPE:
			case DomainmetamodelPackage.ATTRIBUTE__IS_REQUIRED:
			case DomainmetamodelPackage.ATTRIBUTE__IS_DEFAULT:
