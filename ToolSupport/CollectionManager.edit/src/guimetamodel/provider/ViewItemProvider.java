...
/**
 * This is the item provider adapter for a {@link guimetamodel.View} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_title_feature", "_UI_View_type"),
				 GuimetamodelPackage.Literals.VIEW__TITLE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GuimetamodelPackage.Literals.VIEW__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(View.class)) {
			case GuimetamodelPackage.VIEW__TITLE:
			case GuimetamodelPackage.VIEW__NAME:
