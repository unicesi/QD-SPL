...
/**
 * This is the item provider adapter for a {@link kernelmetamodel.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 KernelmetamodelPackage.Literals.ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(KernelmetamodelPackage.Literals.ELEMENT__ATTRIBUTE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Element.class)) {
			case KernelmetamodelPackage.ELEMENT__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case KernelmetamodelPackage.ELEMENT__ATTRIBUTE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(KernelmetamodelPackage.Literals.ELEMENT__ATTRIBUTE,
				 KernelmetamodelFactory.eINSTANCE.createAttribute()));
	}
