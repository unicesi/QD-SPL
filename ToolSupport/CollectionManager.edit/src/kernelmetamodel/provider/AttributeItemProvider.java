...
/**
 * This is the item provider adapter for a {@link kernelmetamodel.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 KernelmetamodelPackage.Literals.ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIsIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_isIdentifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_isIdentifier_feature", "_UI_Attribute_type"),
				 KernelmetamodelPackage.Literals.ATTRIBUTE__IS_IDENTIFIER,
				 true,
				 false,
				 false,
