 ...
 * </p>
 * <ul>
 *   <li>{@link domainmetamodel.impl.EntityImpl#getName <em>Name</em>}</li>
 *   <li>{@link domainmetamodel.impl.EntityImpl#getCharacteristic <em>Characteristic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityImpl extends MinimalEObjectImpl.Container implements Entity {
	...
	protected EClass eStaticClass() {
		return DomainmetamodelPackage.Literals.ENTITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainmetamodelPackage.ENTITY__NAME, oldName, name));
	}
	...
	public EList<Characteristic> getCharacteristic() {
		if (characteristic == null) {
			characteristic = new EObjectContainmentEList<Characteristic>(Characteristic.class, this, DomainmetamodelPackage.ENTITY__CHARACTERISTIC);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DomainmetamodelPackage.ENTITY__CHARACTERISTIC:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainmetamodelPackage.ENTITY__NAME:
				return getName();
			case DomainmetamodelPackage.ENTITY__CHARACTERISTIC:
