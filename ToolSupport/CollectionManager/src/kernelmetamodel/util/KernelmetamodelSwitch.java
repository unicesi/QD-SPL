 ...
 * @generated
 */
public class KernelmetamodelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case KernelmetamodelPackage.KERNEL: {
				Kernel kernel = (Kernel)theEObject;
				T result = caseKernel(kernel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KernelmetamodelPackage.SYSTEM: {
				kernelmetamodel.System system = (kernelmetamodel.System)theEObject;
				T result = caseSystem(system);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KernelmetamodelPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KernelmetamodelPackage.ATTRIBUTE: {
				Attribute attribute = (Attribute)theEObject;
				T result = caseAttribute(attribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KernelmetamodelPackage.SORT: {
	 ...
	 * @generated
	 */
	public T caseSystem(kernelmetamodel.System object) {
		return null;
	}
