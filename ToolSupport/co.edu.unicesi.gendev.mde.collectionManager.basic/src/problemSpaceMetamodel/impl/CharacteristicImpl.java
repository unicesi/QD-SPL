 ...
 * </p>
 * <ul>
 *   <li>{@link problemSpaceMetamodel.impl.CharacteristicImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharacteristicImpl extends MinimalEObjectImpl.Container implements Characteristic {
	...
	protected EClass eStaticClass() {
		return ProblemSpaceMetamodelPackage.Literals.CHARACTERISTIC;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProblemSpaceMetamodelPackage.CHARACTERISTIC__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProblemSpaceMetamodelPackage.CHARACTERISTIC__NAME:
				return getName();
		}
