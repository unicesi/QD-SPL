...
public class AsyncWorkerTemplate {
  public static CharSequence generate(final BusinessEntity be, final String packageName) {
    ...
    _builder.newLine();
    _builder.append("import javax.ejb.AsyncResult;");
    _builder.newLine();
      ...
      for(final Contracts contract : _contracts) {
        {
          if ((contract instanceof ListAll)) {
            ...
            _builder.append("TO>> ");
            String _name_5 = ((ListAll)contract).getName();
            ...
            String _lowerCase_5 = _name_14.toLowerCase();
