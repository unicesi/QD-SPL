...
public class OptimizedFLRImplTemplate {
  ...
  public static CharSequence generate(final BusinessEntity be, final String packageName) {
    try {
      ...
      _builder.append("\t\t");
      String _beginTemplate = DomainCodeUtilities.beginTemplate(OptimizedFLRImplTemplate.className);
      ...
      _builder.append("OptimizedFLR implements I");
      ...
      _builder.newLineIfNotEmpty();
      String _contribute2Template_1 = DomainCodeUtilities.contribute2Template(1);
        ...
        for(final Contracts contract : _contracts) {
          {
            if ((contract instanceof ListAll)) {
              ...
              _builder.newLineIfNotEmpty();
              _builder.append("\t\t");
              _builder.append("if (start != 0)");
              _builder.newLine();
              _builder.append("\t\t\t");
              _builder.append("resultSet.absolute(start);");
              _builder.newLine();
              _builder.append("\t\t");
              ...
              _builder.newLineIfNotEmpty();
              _builder.append("\t\t");
              _builder.append("while (resultSet.next()  && i < maxResults) {");
              _builder.newLine();
              _builder.append("\t\t\t");
