...
public class DAOImplTemplate {
  ...
  public static CharSequence generate(final BusinessEntity be, final String packageName, final List<Association> associations) {
    try {
      ...
      _builder.append("\t\t");
      String _beginTemplate = DomainCodeUtilities.beginTemplate(DAOImplTemplate.className);
      ...
      _builder.newLineIfNotEmpty();
      _builder.newLine();
      String _beginSection = DomainCodeUtilities.beginSection(DomainParams.SECT_ATTRIBUTES);
      _builder.append(_beginSection, "");
      _builder.newLineIfNotEmpty();
      final String attribute2 = DomainCodeUtilities.contribute2Template(1);
      _builder.newLineIfNotEmpty();
      ...
      _builder.newLineIfNotEmpty();
      {
        ...
        for(final Association association : _detailSimpleAssociations) {
          ...
          _builder.append("\t");
          _builder.append("\t\t");
          String _contribute2Template = DomainCodeUtilities.contribute2Template(1, null, be, null, null, null, null, null, Integer.valueOf(3));
      ...
      _builder.newLine();
      {
        ...
        for(final Association association_1 : _detailMultipleAssociations) {
          ...
          _builder.append("\t");
          _builder.append("\t\t");
          String _contribute2Template_1 = DomainCodeUtilities.contribute2Template(1, null, be, null, null, null, null, null, Integer.valueOf(3));
