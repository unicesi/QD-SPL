...
class MasterWithDetailTemplate {
	
	def static generate(String appName, String packageName, BusinessEntity be, String controllerName, BusinessEntity masterBe) '''
			...
			public PopUp«be.name.toFirstUpper»Form() {
				...
				button_1.addClickListener(new ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						«controllerName.toFirstUpper».getInstance().add«be.name.toFirstUpper»To«masterBe.name.toFirstUpper»(«masterBe.name.toLowerCase»);
					}
				});
