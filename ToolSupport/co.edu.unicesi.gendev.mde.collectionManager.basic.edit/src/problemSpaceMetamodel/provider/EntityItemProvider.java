...
/**
 * This is the item provider adapter for a {@link problemSpaceMetamodel.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProblemSpaceMetamodelPackage.Literals.ENTITY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProblemSpaceMetamodelPackage.Literals.ENTITY__CHARACTERISTICS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Entity.class)) {
			case ProblemSpaceMetamodelPackage.ENTITY__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ProblemSpaceMetamodelPackage.ENTITY__CHARACTERISTICS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ProblemSpaceMetamodelPackage.Literals.ENTITY__CHARACTERISTICS,
				 ProblemSpaceMetamodelFactory.eINSTANCE.createCharacteristic()));
	}
